...
// NewInitiateCookingParams creates a new InitiateCookingParams object
// no default values defined in spec.
func NewInitiateCookingParams() InitiateCookingParams {

	return InitiateCookingParams{}
}

// InitiateCookingParams contains all the bound params for the initiate cooking operation
...
func (o *InitiateCookingParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
