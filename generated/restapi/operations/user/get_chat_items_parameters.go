...
// NewGetChatItemsParams creates a new GetChatItemsParams object
// no default values defined in spec.
func NewGetChatItemsParams() GetChatItemsParams {

	return GetChatItemsParams{}
}

// GetChatItemsParams contains all the bound params for the get chat items operation
...
func (o *GetChatItemsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
