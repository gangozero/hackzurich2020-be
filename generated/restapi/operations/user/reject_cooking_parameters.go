...
// NewRejectCookingParams creates a new RejectCookingParams object
// no default values defined in spec.
func NewRejectCookingParams() RejectCookingParams {

	return RejectCookingParams{}
}

// RejectCookingParams contains all the bound params for the reject cooking operation
...
func (o *RejectCookingParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
