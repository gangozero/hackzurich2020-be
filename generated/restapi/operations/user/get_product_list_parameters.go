...
// NewGetProductListParams creates a new GetProductListParams object
...
// GetProductListParams contains all the bound params for the get product list operation
