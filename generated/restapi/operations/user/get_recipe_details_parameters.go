...
// NewGetRecipeDetailsParams creates a new GetRecipeDetailsParams object
// no default values defined in spec.
func NewGetRecipeDetailsParams() GetRecipeDetailsParams {

	return GetRecipeDetailsParams{}
}

// GetRecipeDetailsParams contains all the bound params for the get recipe details operation
...
func (o *GetRecipeDetailsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
